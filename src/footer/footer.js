const form = document.querySelector('#feedback-footer-form');

const submitButton = document.getElementById('submit-btn-feedback-footer');
const checkbox = document.getElementById('confPoliceFooter');
...
form.addEventListener('submit', async function(event) {
    ...
    const name = document.getElementById('name-footer').value;
    const phone = document.getElementById('phone-footer').value;
    const checkbox = document.getElementById('confPoliceFooter');
    ...
    if (name && phone && checkbox.checked) {
        ...
        try {
            ...
            if (data.status === 'success') {
                ...
                document.getElementById('name-footer').value = ""; // Очистка поля 'name-feedback'
                document.getElementById('phone-footer').value = ""; // Очистка поля 'phone-feedback'
...
const submitButtonFeed = document.querySelector('#submit-btn-feedback-footer');

const nameInputFeed = document.getElementById('name-footer');
const phoneInputFeed = document.getElementById('phone-footer');
